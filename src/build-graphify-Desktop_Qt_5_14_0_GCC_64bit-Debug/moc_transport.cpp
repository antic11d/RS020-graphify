...
QT_MOC_LITERAL(3, 18, 9), // "writeData"
QT_MOC_LITERAL(4, 28, 4), // "song"
QT_MOC_LITERAL(5, 33, 5), // "genre"
QT_MOC_LITERAL(6, 39, 9), // "performer"
QT_MOC_LITERAL(7, 49, 8), // "readData"
QT_MOC_LITERAL(8, 58, 13) // "connectToHost"

    },
    "Transport\0closed\0\0writeData\0song\0genre\0"
    "performer\0readData\0connectToHost"
};
...
void Transport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->writeData((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])));
        ...
        {
            using _t = void (Transport::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Transport::closed)) {
                *result = 0;
                return;
            }
        }
